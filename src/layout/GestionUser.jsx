            ...
            <div className="w-full py-5 px-5 flex flex-col gap-5 items-center">
                ...
                <div className="w-full flex justify-center gap-4">
                    <div className={`w-5/12 flex items-center justify-between gap-2 pl-2`}>
                        ...
                        <input id="srh-user" className={`outline-none w-96 h-9 pl-3 rounded-lg border-ebrat-310 border bg-ebrat-transparente text-ebrat-306 placeholder-ebrat-306 font-normal`} placeholder="Telefono"></input>
                    </div>
                    <div className={`w-5/12 flex items-center justify-between gap-2 pl-2`}>
                        <label>Ubicacion</label>
                        <input id="srh-user" className={`outline-none w-96 h-9 pl-3 rounded-lg border-ebrat-310 border bg-ebrat-transparente text-ebrat-306 placeholder-ebrat-306 font-normal`} placeholder="Ubicacion"></input>
                    </div>
                </div>
                <div className="w-full flex items-center justify-center">
                    <div className="w-11/12 flex flex-col items-center">
                        <label>Detalle</label>
                        <textarea className="w-full h-32 outline-none text-ebrat-black p-2"></textarea>
                    </div>
                </div>
            </div>
